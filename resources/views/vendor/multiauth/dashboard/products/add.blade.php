...
@section('content')
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="product-quantity" name="quantity" placeholder="Enter product quantity">
  </div>
  <div class="form-group">
    <label for="product-description">Description</label>
    <textarea class="form-control" id="product-description" name="desc" rows="3" placeholder="Enter product description"></textarea>
  </div>
  <div class="form-group">
    <label for="product-short-description">Short Description</label>
    <input type="text" class="form-control" id="product-short-description" name="short_description"  placeholder="Enter product short description">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="date" class="form-control" id="product-offer-to" name="offer_to">
  </div>
  <div class="form-group">
    <label for="product-offer-from">Offer From</label>
    <input type="date" class="form-control" id="product-offer-from" name="offer_from">
  </div>
  <div class="form-group">
    <label for="product-offer-price">Offer Price</label>
    <input type="number" class="form-control" id="product-offer-price" name="offer_price" placeholder="Enter offer price">
  </div>
  <div class="form-group">
    <label for="product-mrp">Rental Price</label>
    <input type="number" class="form-control" id="product-mrp" name="mrp" placeholder="Enter MRP">
  </div>
  <div class="form-group">
