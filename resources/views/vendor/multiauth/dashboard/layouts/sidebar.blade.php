            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview ">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('adventure_packages.index') }}" class="nav-link ">
                                <i class="far fa fa-lock"></i>
                                <p>{{__("All Adventure Packages")}}</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('adventure_tickets.index') }}" class="nav-link ">
                                <i class="far fa fa-lock"></i>
                                <p>{{__("All Adventure Tickets")}}</p>
                            </a>
                        </li>
