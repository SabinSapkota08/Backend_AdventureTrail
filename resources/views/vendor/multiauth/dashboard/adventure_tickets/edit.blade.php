...
@section('content')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form method="post" action="{{route("adventure_ticket.update",$adventureTicket->id)}}"  enctype="multipart/form-data">
                                @csrf
  <div class="form-group">
    <label for="adventure_ticket-name">Product Name</label>
    <input type="text" class="form-control" id="adventure_ticket-name" name="name" value="{{$adventureTicket->name}}" placeholder="Enter adventure_package name">
  </div>
  <div class="form-group">
    <label for="adventure_ticket-quantity">Quantity</label>
    <input type="number" class="form-control" id="adventure_ticket-quantity" name="quantity" value="{{$adventureTicket->quantity}}" placeholder="Enter adventure_package quantity">
  </div>
  <div class="form-group">
    <label for="adventure_ticket-description">Description</label>
    <textarea class="form-control" id="adventure_ticket-description" name="description"  rows="3" placeholder="Enter product description">
    {{$adventureTicket->description}}
    </textarea>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="adventure_ticket-price" name="price" value="{{$adventureTicket->price}}" placeholder="Enter Price">
  </div>
  <div class="form-group">
    <label for="adventure_ticket-category">Category</label>
    <select class="form-control" id="adventure_ticket-category" name="category" value="{{$adventureTicket->category}}">
